...
owon.set_channel(channel=CH2,range='5v',offset=0.5,probe='1x',coupling=AC) # para 81 kHz e Idc< 8 A hay que cambiar range de 50v a 5v
...
promediador_señales(freq=20,num_prom=20,
                    name='081kHz_015dA_100Mss_bobN1FR',
                    plot_range=0.2)
